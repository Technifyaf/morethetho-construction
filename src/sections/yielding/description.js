				...
				<Flex sx={styles.contentWrapper}>
					...
					<Box sx={styles.rightContent}>
						<SectionHeading
							...
							description='The test is carried out to determine borehole performance, recovery and the correct pump size to be installed. Upon completion of drilling process the test would be carried out by a hydrologist and report provided thereafter. The pump test is normally done at a charge.
              '
						/>
