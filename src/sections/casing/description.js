				...
				<Flex sx={styles.contentWrapper}>
					...
					<Box sx={styles.rightContent}>
						<SectionHeading
							...
							description='It is vital to case the borehole to prevent underground collapse and reduce sand penetration into the borehole. The borehole can be fully or partially cased depending on the underground formation or water sources. Perforated UPVC or MPVC casings will be installed after drilling of the borehole as may be determined by soil samples.'
						/>
